...
*/
function fansee_biz_register_metabox(){
	add_meta_box( 
		'fansee-business-meta-box', 
		esc_html__( 'Fansee Business Settings', 'fansee-biz' ), 
		'fansee_biz_render_metabox', 
		'post',
		'side'
	);
...
add_action( 'add_meta_boxes', 'fansee_biz_register_metabox' );

function fansee_biz_render_metabox( $post ){
	wp_nonce_field( 'fansee_biz_meta_nonce', 'fansee_biz_name_meta_nonce' );
	...
	<div class="fansee-business-metabox-wrapper">
		...
		<div class="fansee-business-metabox-checkbox">
			<label for="fansee-business-use-customizer-image-for-banner">
				<?php esc_html_e( 'Use banner from customizer', 'fansee-biz' ); ?>
			</label>
		...
		<div class="fansee-business-metabox-checkbox">
			<label for="fansee-business-disable-inner-banner"><?php esc_html_e( 'Disable Banner', 'fansee-biz' ); ?></label>
		...
		<div class="fansee-business-metabox-checkbox">
			<label for="fansee-business-disable-footer-widget"><?php esc_html_e( 'Disable Footer Widget', 'fansee-biz' ); ?></label>
...
function fansee_biz_save_metabox( $post_id ){
	      	
  	$p = wp_unslash( $_POST );
  	$is_autosave = wp_is_post_autosave( $post_id );
	$is_revision = wp_is_post_revision( $post_id );

	if ( $is_autosave || $is_revision || empty( $p ) || ! isset(  $p[ 'fansee_biz_name_meta_nonce' ] ) || ! wp_verify_nonce( $p[ 'fansee_biz_name_meta_nonce' ], 'fansee_biz_meta_nonce' )) {
		return;
	}
...
add_action( 'save_post', 'fansee_biz_save_metabox' );